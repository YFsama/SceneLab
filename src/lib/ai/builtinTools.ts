  ...
  registerTool({
    ...
    parameters: {
      ...
      properties: {
        type: {
          type: 'string',
          enum: ['horizontal', 'vertical', 'parallel', 'perpendicular', 'equal', 'distance'],
    ...
    execute: async (args) => {
      const type = assertEnum(args.type, ['horizontal', 'vertical', 'parallel', 'perpendicular', 'equal', 'distance'] as const, 'type');
